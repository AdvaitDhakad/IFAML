...
@app.route("/api/available-preprocess-cleaning", methods=["GET"])
def get_available_preprocess_cleaning():
    f = open("api/preprocess_cleaning.json")
    return json.load(f)

@app.route("/api/available-preprocess-encoding", methods=["GET"])
def get_available_preprocess_encoding():
    f = open("api/preprocess_encoding.json")
    return json.load(f)

@app.route("/api/available-preprocess-scaling", methods=["GET"])
def get_available_preprocess_scaling():
    f = open("api/preprocess_scaling.json")
    return json.load(f)
